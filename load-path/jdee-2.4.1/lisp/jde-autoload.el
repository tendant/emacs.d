
;;;### (autoloads (bsh-script-help) "beanshell" "beanshell.el" (20123
;;;;;;  22396))
...
;;;;;;  "jde-ant" "jde-ant.el" (20123 22396))
...
;;;;;;  "jde-bookmark" "jde-bookmark.el" (20123 22396))
...
;;;***

;;;### (autoloads (jde-bug-debug-app) "jde-bug" "jde-bug.el" (20123
;;;;;;  22396))
...
;;;***

;;;### (autoloads nil "jde-compat" "jde-compat.el" (20123 22396))
...
;;;;;;  "jde-ejb" "jde-ejb.el" (20123 22396))
...
;;;;;;  jde-gen-class-buffer) "jde-gen" "jde-gen.el" (20123 22396))
...
(defvar jde-gen-equals-method-template '("'>" "\"/**\" '> 'n" "\" * Check if this object is equal (equivalent) to another object.\" '> 'n" "\" */\" '> 'n" "(jde-gen-method-signature \"public\" \"boolean\" \"equals\" \"Object obj\")" "(jde-gen-electric-brace)" "\"if (obj == this) return true;\" '> 'n" "\"if ((obj == null) || !getClass().equals(obj.getClass())) return false;\" '> 'n" "'> 'n" "(jde-gen-equals-return \"obj\" \"o\") '> 'n" "\"}\" '> 'n '>))") "\
...
;;;;;;  "jde-java-font-lock.el" (20123 22396))
...
;;;;;;  "jde-java-properties" "jde-java-properties.el" (20123 22396))
...
;;;;;;  "jde-javadoc-gen" "jde-javadoc-gen.el" (20123 22396))
...
;;;;;;  "jde-open-source.el" (20123 22396))
...
;;;;;;  "jde-parse-expr" "jde-parse-expr.el" (20123 22396))
...
;;;;;;  "jde-project-file" "jde-project-file.el" (20123 22396))
...
;;;;;;  "jde-project" "jde-project.el" (20123 22396))
...
;;;;;;  "jde-refactor" "jde-refactor.el" (20123 22396))
...
;;;;;;  jde-run-set-app) "jde-run" "jde-run.el" (20123 22396))
...
;;;;;;  jde-stat-loc-report) "jde-stat" "jde-stat.el" (20123 22396))
...
;;;;;;  "jde-util" "jde-util.el" (20123 22396))
...
;;;;;;  jde-xref-make-xref-db) "jde-xref" "jde-xref.el" (20123 22396))
...
;;;;;;  jde-set-global-classpath jde-version) "jde" "jde.el" (20123
;;;;;;  22396))
