...
(defvar my-packages '(cider clojure-mode solarized-theme yasnippet w3m magit magit-svn ac-nrepl notmuch graphviz-dot-mode helm helm-ls-git clojure-snippets slamhound yaml-mode exec-path-from-shell js2-mode web-mode flycheck flycheck-clojure swift-mode))
